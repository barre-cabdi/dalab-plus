...
import { CalendarIcon, Download, Search, Filter, TrendingUp, ShoppingBag, DollarSign } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl shadow-card-custom overflow-hidden">
        <Table>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              <TableRow><TableCell colSpan={6} className="text-center text-muted-foreground py-8">No orders match your filters</TableCell></TableRow>
            ) : filtered.map((o, i) => (
